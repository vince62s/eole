...
class TransformerDecoder(DecoderBase):
    ...
    def __init__(
        ...
        context_length = getattr(running_config, "context_length", 0)
        self.max_length = context_length if context_length > 0 else getattr(running_config, "max_new_tokens", 256)
