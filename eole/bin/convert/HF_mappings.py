...
MODEL_OVERRIDES = {
    ...
    # Qwen3.5 text-only (dense) — architecture used by standalone Qwen3.5-*B models
    # and by AutoRound-quantized derivatives (e.g. kaitchup/Qwen3.5-27B-autoround-W4A16)
    "Qwen3_5ForCausalLM": {
        "decoder": {
            ".self_attn.q_norm.": ".self_attn.q_norm.",
            ".self_attn.k_norm.": ".self_attn.k_norm.",
