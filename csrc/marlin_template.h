...
// Shared device helper functions (ldsm, scale, scale_and_sub, sub_zp, scale4,
// scale_float, barrier_acquire, barrier_release, wait_negative_and_add).
// Included here inside namespace MARLIN_NAMESPACE_NAME so that MarlinScalarType
// is in scope.  The dense kernel uses the same helpers via marlin_helpers.h.
